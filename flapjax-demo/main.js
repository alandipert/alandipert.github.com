...
cljs.core.UUID;
goog.provide("alandipert.flapjax_demo.sum");
goog.require("cljs.core");
goog.require("flapjax");
alandipert.flapjax_demo.sum.parse_float = function parse_float(s, default$) {
  var n = parseFloat(s);
...
alandipert.flapjax_demo.sum.extractNumberE = function extractNumberE(id, default$) {
  return flapjax.mapE.call(null, function(p1__3790_SHARP_) {
    return alandipert.flapjax_demo.sum.parse_float.call(null, p1__3790_SHARP_, default$)
  }, flapjax.extractValueE.call(null, id))
};
alandipert.flapjax_demo.sum.extractNumberB = function extractNumberB(id, default$) {
  return flapjax.startsWith.call(null, alandipert.flapjax_demo.sum.extractNumberE.call(null, id, default$), default$)
};
alandipert.flapjax_demo.sum.sumB = function() {
  var sumB__delegate = function(behaviors) {
    return cljs.core.apply.call(null, flapjax.liftB, function() {
      var G__3793__delegate = function(rest__3791_SHARP_) {
        return cljs.core.apply.call(null, cljs.core._PLUS_, rest__3791_SHARP_)
      };
      var G__3793 = function(var_args) {
        var rest__3791_SHARP_ = null;
        if(goog.isDef(var_args)) {
          rest__3791_SHARP_ = cljs.core.array_seq(Array.prototype.slice.call(arguments, 0), 0)
        }
        return G__3793__delegate.call(this, rest__3791_SHARP_)
      };
      G__3793.cljs$lang$maxFixedArity = 0;
      G__3793.cljs$lang$applyTo = function(arglist__3794) {
        var rest__3791_SHARP_ = cljs.core.seq(arglist__3794);
        return G__3793__delegate(rest__3791_SHARP_)
      };
      G__3793.cljs$lang$arity$variadic = G__3793__delegate;
      return G__3793
    }(), behaviors)
  };
  var sumB = function(var_args) {
    var behaviors = null;
    if(goog.isDef(var_args)) {
      behaviors = cljs.core.array_seq(Array.prototype.slice.call(arguments, 0), 0)
    }
    return sumB__delegate.call(this, behaviors)
  };
  sumB.cljs$lang$maxFixedArity = 0;
  sumB.cljs$lang$applyTo = function(arglist__3795) {
    var behaviors = cljs.core.seq(arglist__3795);
    return sumB__delegate(behaviors)
  };
  sumB.cljs$lang$arity$variadic = sumB__delegate;
  return sumB
}();
alandipert.flapjax_demo.sum.calculate = function() {
  var calculate__delegate = function(target_id, source_ids) {
    var arguments = cljs.core.map.call(null, function(p1__3792_SHARP_) {
      return alandipert.flapjax_demo.sum.extractNumberB.call(null, p1__3792_SHARP_, 0)
    }, source_ids);
    var results = cljs.core.apply.call(null, alandipert.flapjax_demo.sum.sumB, arguments);
    return flapjax.insertValueB.call(null, results, target_id, "innerHTML")
  };
  var calculate = function(target_id, var_args) {
    var source_ids = null;
    if(goog.isDef(var_args)) {
      source_ids = cljs.core.array_seq(Array.prototype.slice.call(arguments, 1), 0)
    }
    return calculate__delegate.call(this, target_id, source_ids)
  };
  calculate.cljs$lang$maxFixedArity = 1;
  calculate.cljs$lang$applyTo = function(arglist__3796) {
    var target_id = cljs.core.first(arglist__3796);
    var source_ids = cljs.core.rest(arglist__3796);
    return calculate__delegate(target_id, source_ids)
  };
  calculate.cljs$lang$arity$variadic = calculate__delegate;
  return calculate
}();
